...
### Type-Function Pattern Architecture (NOTE: Optional/Reference Only)

> **WARNING**: The Type-Function pattern is a Red Hat CoP standard but is **NOT MANDATORY** for personal projects. It serves as a helpful example of organization. For homelab use, hosts are often multi-purpose, and "one host = one type" rigidity is explicitly discouraged. Prioritize aesthetic clarity and project-level consistency instead.

The Type-Function pattern is one way to design automation:
