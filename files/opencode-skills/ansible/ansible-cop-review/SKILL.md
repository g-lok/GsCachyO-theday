...
#### Type-Function Pattern (NOTE: Flexibility Permitted)

**Standard (Reference Only):**
> **WARNING**: Strict adherence to the Type-Function architecture is not required for personal projects. While it provides a good structural baseline, reviewers should prioritize technical rigor (idempotency, naming) over rigid host classification ("one host = one type").
