...
alias jjf="jj file"
alias jjfixdiv="jj metaedit --update-change-id"
...
alias jjld="jj log -r 'all()' -T builtin_log_detailed"
alias jjlo="jj log -r 'all()' -T builtin_log_oneline"
alias jjlf="jj git fetch --quiet && jj log -r 'all()'"
alias jjn="jj new"
alias jjnm="jj new -m"
alias jjnx="jj next"
