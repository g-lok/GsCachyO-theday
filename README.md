...
- Enabling system services. I didn't bother messing with any services here, you'll have to enable them yourself. [EDIT: I enable all system services in run.sh, comment or delete those bits if you want finer grain control]
